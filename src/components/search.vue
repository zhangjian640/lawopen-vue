  ...
  <div class="content">
    <ul class="left-content">
      ...
      <li>
        <label for="phoneNum">
          <span>手机号码&nbsp;:&nbsp;</span>
          <input type="text" id="phoneNum" class="input-area phone-num">
        </label>
      </li>
      <li>
        <label for="checkCode">
          <span>查询编码&nbsp;:&nbsp;</span>
          <input type="text" id="checkCode" class="input-area check-code">
        </label>
      </li>
      <li>
      ...
      <li class="btns">
        <div class="btn login-btn"></div>
        <div class="btn back-btn"></div>
      </li>
    </ul>
